...
% Problem  : [i0,i10) vs [i10,i20], first open at i10 -> Conflict
% Version  : 1.0
% English  : dateTime in [i0,i10) (OPEN upper, via lt) vs [i10,i20] (closed lower). The first
...
%           : Policy source: Policies/ODRL834-policy.ttl
%--------------------------------------------------------------------------
...
% ─── Conjecture ────────────────────────────────────────────────────
fof(odrl834, conjecture,
    disjoint(i0, i10, c, o, i10, i20, c, c)).
%--------------------------------------------------------------------------
