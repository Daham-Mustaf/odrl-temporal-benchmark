...
% Version  : 1.0
% English  : elapsedTime: eq P600D -> {600}   lteq P1200D -> [0,1200]
...
%           : Policy source: Policies/ODRL807-policy.ttl
%--------------------------------------------------------------------------
...
% ─── Conjecture ────────────────────────────────────────────────────
fof(odrl807, conjecture,
    ?[X]: (in_closed(X, p600, p600) & in_closed(X, d0, p1200))).
%--------------------------------------------------------------------------
